...
public class PdfService {
    ...
    public void createPdf(CompanyDto companyDto) throws FileNotFoundException {

//        createBasicPDF(path);
        boolean isFileLocationCreated = createFolderIfNotPresent(path);
//        createCanvasPdf(path);
        createTable(path, companyDto);

    }

    private void createTable(String destPath, CompanyDto companyDto) throws FileNotFoundException {
